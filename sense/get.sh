...
curl -s -H "Content-Type: application/json" -X GET "https://api.sense-os.nl/sensors/$sensor/data?username=$username&password=$password&page=$page" -o "$result_folder/$page.txt"
